...
enum Key : unsigned
{
    ...
    KEY_BACKQUOTE = SDLK_GRAVE,
    KEY_BACKSLASH = SDLK_BACKSLASH,
    // SDL3 移除了以下按键：亮度 / 计算器 / 电脑 / 屏幕切换 / 键盘背光 / 邮件 / WWW
    // 相关枚举已删除以保持与 SDL3 对齐
    ...
    KEY_QUOTE = SDLK_APOSTROPHE,
    KEY_QUOTEDBL = SDLK_DBLAPOSTROPHE,
...
enum Scancode : unsigned
{
    ...
    // SDL3 改名：音频/媒体键使用 SDL_SCANCODE_MEDIA_*；静音使用 SDL_SCANCODE_MUTE
    ...
    // SDL3 移除了以下扫描码：WWW/MAIL/COMPUTER/CALCULATOR/亮度/显示切换/键盘背光/APP1/APP2
    // 保留常见媒体扫描码与电源键
...
{
    CONTROLLER_BUTTON_A = SDL_GAMEPAD_BUTTON_SOUTH,
    CONTROLLER_BUTTON_B = SDL_GAMEPAD_BUTTON_EAST,
    CONTROLLER_BUTTON_X = SDL_GAMEPAD_BUTTON_WEST,
    CONTROLLER_BUTTON_Y = SDL_GAMEPAD_BUTTON_NORTH,
    CONTROLLER_BUTTON_BACK = SDL_GAMEPAD_BUTTON_BACK,
    CONTROLLER_BUTTON_GUIDE = SDL_GAMEPAD_BUTTON_GUIDE,
    CONTROLLER_BUTTON_START = SDL_GAMEPAD_BUTTON_START,
    CONTROLLER_BUTTON_LEFTSTICK = SDL_GAMEPAD_BUTTON_LEFT_STICK,
    CONTROLLER_BUTTON_RIGHTSTICK = SDL_GAMEPAD_BUTTON_RIGHT_STICK,
    CONTROLLER_BUTTON_LEFTSHOULDER = SDL_GAMEPAD_BUTTON_LEFT_SHOULDER,
    CONTROLLER_BUTTON_RIGHTSHOULDER = SDL_GAMEPAD_BUTTON_RIGHT_SHOULDER,
    CONTROLLER_BUTTON_DPAD_UP = SDL_GAMEPAD_BUTTON_DPAD_UP,
    CONTROLLER_BUTTON_DPAD_DOWN = SDL_GAMEPAD_BUTTON_DPAD_DOWN,
    CONTROLLER_BUTTON_DPAD_LEFT = SDL_GAMEPAD_BUTTON_DPAD_LEFT,
    CONTROLLER_BUTTON_DPAD_RIGHT = SDL_GAMEPAD_BUTTON_DPAD_RIGHT,
};

enum ControllerAxis : unsigned
{
    CONTROLLER_AXIS_LEFTX = SDL_GAMEPAD_AXIS_LEFTX,
    CONTROLLER_AXIS_LEFTY = SDL_GAMEPAD_AXIS_LEFTY,
    CONTROLLER_AXIS_RIGHTX = SDL_GAMEPAD_AXIS_RIGHTX,
    CONTROLLER_AXIS_RIGHTY = SDL_GAMEPAD_AXIS_RIGHTY,
